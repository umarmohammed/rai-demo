...
import { getDomain, getScale } from '@swimlane/ngx-charts';
import { id } from '@swimlane/ngx-charts';

@Component({
  selector: 'ngx-charts-custom-bubble-chart',
  template: `
    <ngx-charts-chart
      [view]="[width, height]"
      [showLegend]="legend"
      ...
      <svg:g [attr.transform]="transform" class="bubble-chart chart">
        ...
        <svg:g [attr.clip-path]="clipPath">
          <svg:g [@animationState]="'active'">
            <svg:g
              ngx-charts-custom-bubble-series
              [xScale]="xScale"
              [yScale]="yScale"
              [rScale]="rScale"
...
export class CustomBubbleChartComponent extends BaseChartComponent {
